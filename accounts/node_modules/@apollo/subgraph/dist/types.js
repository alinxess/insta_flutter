...
function entitiesResolver({ representations, context, info }) {
    return representations.map((reference) => {
        ...
        const resolveReference = (_c = (_b = (_a = type.extensions.apollo) === null || _a === void 0 ? void 0 : _a.subgraph) === null || _b === void 0 ? void 0 : _b.resolveReference) !== null && _c !== void 0 ? _c : function defaultResolveReference() {
            return reference;
        };
